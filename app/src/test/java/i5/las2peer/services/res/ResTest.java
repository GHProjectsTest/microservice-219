...
public class ResTest {
  ...
  /**
   * 
   * Test for the FirstTest_ID839782 method.
   * 
   */
  @Test
  public void testFirstTest_ID839782() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 988535: " + result.getResponse().trim());
    
      Assert.assertEquals("[908013]", 200, result.getHttpCode());
  Object response = JSONValue.parse(result.getResponse().trim());
      // Response body has type User
      assertThat("[569811]", response, both(isA(JSONObject.class)).and(asJSONObject(followsSchema("User", """
